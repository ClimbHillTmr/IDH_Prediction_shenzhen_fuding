...
y_true = y_test
y_pred_1 = LGBM_Truemodel[6].predict_proba(X_test.values)[:, 1]
y_pred_2 = LDR_Truemodel[6].predict_proba(X_test.values)[:, 1]
y_pred_3 = XGB_Truemodel[6].predict_proba(X_test.values)[:, 1]

alpha = 0.99
# pvalue
pvalue = delong_roc_test(y_true, y_pred_1, y_pred_3)
aucs, auc_cov = delong_roc_variance(y_true, y_pred)
auc_1, auc_cov_1 = delong_roc_variance(y_true, y_pred_1)
auc_2, auc_cov_2 = delong_roc_variance(y_true, y_pred_2)
auc_2, auc_cov_3 = delong_roc_variance(y_true, y_pred_3)
